...
if (systemlib_ABSEIL_CPP)
  ...
  add_library(abseil_cpp_build INTERFACE)
  target_link_libraries(abseil_cpp_build  
	       INTERFACE
	       absl_base
               absl_spinlock_wait
               absl_dynamic_annotations
  ...
  list(APPEND tensorflow_EXTERNAL_DEPENDENCIES absl::base)
  list(APPEND tensorflow_EXTERNAL_DEPENDENCIES absl::base_internal)
  list(APPEND tensorflow_EXTERNAL_DEPENDENCIES absl::spinlock_wait)
  list(APPEND tensorflow_EXTERNAL_DEPENDENCIES absl::dynamic_annotations)
  list(APPEND tensorflow_EXTERNAL_DEPENDENCIES absl::malloc_internal)
  list(APPEND tensorflow_EXTERNAL_DEPENDENCIES absl::throw_delegate)
  list(APPEND tensorflow_EXTERNAL_DEPENDENCIES absl::int128)
  list(APPEND tensorflow_EXTERNAL_DEPENDENCIES absl::strings)
  list(APPEND tensorflow_EXTERNAL_DEPENDENCIES absl::str_format_internal)
  list(APPEND tensorflow_EXTERNAL_DEPENDENCIES absl::bad_optional_access)
  
  list(APPEND tensorflow_EXTERNAL_LIBRARIES absl::base)
  list(APPEND tensorflow_EXTERNAL_LIBRARIES absl::base_internal)
  list(APPEND tensorflow_EXTERNAL_LIBRARIES absl::spinlock_wait)
  list(APPEND tensorflow_EXTERNAL_LIBRARIES absl::dynamic_annotations)
  list(APPEND tensorflow_EXTERNAL_LIBRARIES absl::malloc_internal)
  list(APPEND tensorflow_EXTERNAL_LIBRARIES absl::throw_delegate)
  list(APPEND tensorflow_EXTERNAL_LIBRARIES absl::int128)
  list(APPEND tensorflow_EXTERNAL_LIBRARIES absl::strings)
  list(APPEND tensorflow_EXTERNAL_LIBRARIES absl::str_format_internal)
  list(APPEND tensorflow_EXTERNAL_LIBRARIES absl::bad_optional_access)
...
#        ${abseil_cpp_BUILD}/absl/strings/libstr_format_internal.a
  ...
  ExternalProject_Add(abseil_cpp_build
      ...
      GIT_TAG "9613678332c976568272c8f4a78631a29159271d"
  ...
  #list(APPEND tensorflow_EXTERNAL_LIBRARIES abseil_cpp_build)
  list(APPEND tensorflow_EXTERNAL_LIBRARIES absl::base)
  list(APPEND tensorflow_EXTERNAL_LIBRARIES absl::base_internal)
  list(APPEND tensorflow_EXTERNAL_LIBRARIES absl::spinlock_wait)
  list(APPEND tensorflow_EXTERNAL_LIBRARIES absl::dynamic_annotations)
